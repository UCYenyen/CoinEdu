                  ...
                  <thead>
                    <tr className="border-b border-border text-muted-foreground text-xs uppercase">
                      ...
                      <th className="text-right px-5 py-3 font-semibold whitespace-nowrap">
                        <MetricInfo 
                          title="Holdings" 
                          description="The total current market value of your owned assets in USD."
                          metricId="holdings"
                      ...
                      <th className="text-right px-5 py-3 font-semibold whitespace-nowrap">
                        <MetricInfo 
                          title="Avg. Buy" 
                          description="The weighted average price you paid to acquire these tokens."
                          metricId="avgBuy"
                          className="justify-end"
                        />
                      </th>
                      <th className="text-right px-5 py-3 font-semibold whitespace-nowrap">
                        <MetricInfo 
                          title="P&L" 
                          description="Profit & Loss (Unrealized) based on current marker price vs your average buy price."
                          metricId="pnl"
                          className="justify-end"
                        />
                      </th>
